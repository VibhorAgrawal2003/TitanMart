...
const ProductCard: React.FC<ProductCardProps> = ({ name, category, imageUrl, cost }) => {
    return (
        <div className='w-64 mx-auto overflow-hidden bg-white'>
            <div className='p-4 text-center flex flex-col items-center h-full'>
                ...
                <button className='w-full bg-green-500 text-white text-sm font-semibold py-2 mt-4 rounded-md'>
                    Add to Cart
                </button>
            </div>
        </div>
